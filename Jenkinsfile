    ...
    stages {
      stage('CI Build and push snapshpt') {
        ...
        steps {
          ...
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-jr1') {
            checkout scm
            container('go') {
              sh "make preview"
          ...
          dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-jr1/charts/preview') {
           container('go') {
             sh "make linux"
      ...
      stage('Build Release') {
        ...
        steps {
          container('go') {
            ...
            dir ('/home/jenkins/go/src/github.com/rawlingsj/golang-jr1/charts/golang-jr1') {
